...
// Auto-migrate campus locations if not done yet
if (!isset($_SESSION['campus_locations_updated'])) {
    try {
        $locations_migration = [
        ...
        foreach ($locations_migration as $loc) {
        ...
        $_SESSION['campus_locations_updated'] = true;
    } catch (PDOException $e) {}
}
